...
import {updateSymbols} from '../../services/SymbolsService';
/**
 * 
 * props:
 * - data
...
function SymbolModal(props) {
    ...
    function onInputChange(event){
        setSymbol(preventState => ({ ...preventState, [event.target.id]: event.target.value }));
    }
    ...
    function onFavoriteClick(event){
        setSymbol(preventState => ({ ...preventState, isFavorite: !symbol.isFavorite }));
            ...
            <div className="modal-dialog modal-dialog-centered" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        ...
                        <button type="button" ref={btnClose} className="btn-close" data-bs-dismiss="modal" aria-label="close"></button>
                    </div>
